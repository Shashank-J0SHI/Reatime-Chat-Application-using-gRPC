...
/**
 * optional int32 profile = 3;
 * @return {number}
 */
proto.User.prototype.getProfile = function() {
 ...
 * @return {!proto.User} returns this
 */
proto.User.prototype.setProfile = function(value) {
 ...
 * @return {string}
 */
proto.ReceiveMsgRequest.prototype.getToken = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.ReceiveMsgRequest} returns this
 */
proto.ReceiveMsgRequest.prototype.setToken = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
